...
public class ResultTest {
    ...
    public void testGetID() {
        ...
        // om getString("name") anropas så returnera "" tomma strängen
        when( resultRecordMock.get("resultsid")).thenReturn("");
        
        Result instance = new Result(resultRecordMock); // Injicera beroendet (av mockat objekt)
        int expResult = 0;
       ...
       // String exp = 0;
        ...
        verify(resultRecordMock, times(1)).getInteger("resultsid"); // kontrollera beteendet (getString anropas)
